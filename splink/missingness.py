def missingness_sqls(columns, input_tablename):
    ...
    sqls.append(
        {
            "sql": sql,
            "output_table_name": "__splink__null_counts_for_columns",
        }
    )
    ...
    select
        ...
        column_name
    from __splink__null_counts_for_columns
    """

    sqls.append({"sql": sql, "output_table_name": "__splink__missingness_data_for_chart"})
